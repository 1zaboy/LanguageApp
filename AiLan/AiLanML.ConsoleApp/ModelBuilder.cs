...
namespace AiLanML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"../../../../AiLanML.ConsoleApp/wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../AiLanML.Model/MLModel.zip";
